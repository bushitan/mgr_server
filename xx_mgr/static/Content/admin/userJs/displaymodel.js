layui.config({
    ...
    var mainList = function (options) {
        ...
        table.reload('mainList', {
            url: '/administrator/DisplayModule/Load',
            where: config
        });
    }
    ...
    var editDlg = function () {
        ...
        var show = function (data) {
            ...
            layer.open({
                ...
                area: ["98%", "98%"],
                type: 2,
                content: /*$('#divEdit')*/update ? common.renderUrl('/administrator/DisplayModule/Update', {
                    id: data.Id
                }) : common.renderUrl('/administrator/DisplayModule/Add', {
                    id: data.Id
                }),
                //success: function () {
                //    //vm.$set('$data', data);
    ...
    var meditDlg = function () {
        ...
        var show = function (data) {
            ...
            var url = "/administrator/DisplayModule/AddMenu";
            if (update) {
                url = "/administrator/DisplayModule/UpdateMenu";
            }
            //提交数据
    ...
    var active = {
        btnDel: function () {      //删除模块
            ...
            openauth.del("/administrator/DisplayModule/Delete",
