layui.config({
    ...
    //提交的URL
    var url = "/administrator/NewsManager/Save";
    ...
    var ue = UE.getEditor('myFormDesign', {
        ...
        toolbars: [[
            ...
            , '|', 'inserttable', 'deletetable', 'mergecells', 'splittocells', 'anchor' //锚点                         
        ...
        , iframeCssUrl: "/Content/admin/js/ueditor/formdesign/bootstrap/css/bootstrap.min.css" //引入自身 css使编辑器兼容你网站css
        //更多其他参数，请参考ueditor.config.js中的配置项
    });

    //封面
    //var imgue = UE.getEditor('myFormDesignimg', {
    //    //allowDivTransToP: false,//阻止转换div 为p
